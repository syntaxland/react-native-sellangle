...
import { deactivatePaidAd } from "../../redux/actions/marketplaceSellerActions";
...
function DeactivatePaidAd({ ad_id }) {
  ...
  const deactivatePaidAdState = useSelector(
    (state) => state.deactivatePaidAdState
  );
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <TouchableOpacity
          ...
          onPress={handleDeactivatePaidAd}
