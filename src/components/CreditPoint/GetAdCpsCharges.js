...
const GetAdCpsCharges = () => {
  ...
  const totalPages = Math.ceil(adCpsCharges?.length / itemsPerPage);
      ...
      >
        <View style={styles.container}>
          <Text style={styles.title}>
            <FontAwesomeIcon icon={faCreditCard} /> CPS Ad Charges
          </Text>
          {loading ? (
            <Loader />
          ) : error ? (
            ...
            <>
              {currentItems.length === 0 ? (
                <Text style={styles.noData}>Ad CPS charges appear here.</Text>
              ) : (
                      ...
                      <DataTable.Row key={cps.id}>
                        ...
                        <DataTable.Cell style={styles.cell}>
                          <ScrollView horizontal>
                            <Text>{cps.ad_charge_cps_id}</Text>
                          </ScrollView>
                        </DataTable.Cell>
                        <DataTable.Cell style={styles.cell}>
                          <ScrollView horizontal>
